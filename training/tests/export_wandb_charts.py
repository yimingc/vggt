...
def export_charts(run_path: str, output_dir: str):
    ...
    chart_configs = [
        ...
        {
            "name": "sqrt_info_percentiles",
            "title": "√λ Percentiles (Confidence Evolution)",
            "metrics": ["diagnostic/sqrt_info_rot_p90", "diagnostic/sqrt_info_rot_p99",
                       "diagnostic/sqrt_info_trans_p90", "diagnostic/sqrt_info_trans_p99"],
            "ylabel": "√λ value",
        },
        {
            "name": "clamp_hit_rate",
            "title": "Clamp Hit Rate",
            "metrics": ["diagnostic/sqrt_info_rot_clamp_hit", "diagnostic/sqrt_info_trans_clamp_hit"],
            "ylabel": "Fraction at upper bound",
        },
        {
    ...
    with open(summary_path, 'w') as f:
        ...
        key_metrics = [
            ...
            "diagnostic/sqrt_info_rot_p90",
            "diagnostic/sqrt_info_trans_p90",
            "diagnostic/sqrt_info_rot_clamp_hit",
            "diagnostic/sqrt_info_trans_clamp_hit",
